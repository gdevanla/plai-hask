...
interpretExprC :: ExprC -> Binding -> M.Map Symbol FuncDefC -> Integer
interpretExprC (PlusC x y) env fdef = (+) (interpretExprC x env fdef) (interpretExprC y env fdef)
interpretExprC (MultC x y) env fdef = (*) (interpretExprC x env fdef) (interpretExprC y env fdef)
